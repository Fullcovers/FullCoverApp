  ...
  void setClubsData(List<dynamic> data) {
    clubsData = data
        .map((item) => ClubModel(
            ...
            daddress: item.containsKey('d_address')
                ? Clubdaddress(
                    city: item['d_address'].containsKey('city')
                        ? item['d_address']['city']
                        : '',
                    plot: item['d_address'].containsKey('plot')
                        ? item['d_address']['plot']
                        : '',
                    postalcode: item['d_address'].containsKey('postal_code')
                        ? item['d_address']['postal_code']
                        : '',
                    state: item['d_address'].containsKey('state')
                        ? item['d_address']['state']
                        : '',
                    landmark: item['d_address'].containsKey('landmark')
                        ? item['d_address']['landmark']
                        : '',
                  )
                : Clubdaddress(
                    city: '',
  ...
  ClubModel getClubDetails(Map<String, dynamic> item) {
    return ClubModel(
      ...
      daddress: item.containsKey('d_address')
          ...
          : Clubdaddress(
              city: '', plot: '', postalcode: '', state: '', landmark: ''),
    );
  }
