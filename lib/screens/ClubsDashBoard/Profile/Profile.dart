...
class _BTSProfileState extends State<BTSProfile> {
  ...
  bool loded = false;
  getuser() async {
    user = await UserServices.getprofileinfo(context: context);
    setState(() {
      loded = true;
    });
  }
          ...
          ? Column(children: [
              ...
              InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => BTSEditProfile()));
                },
                child: Padding(
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => const BTSTicket()));
                  },
                  child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Image.asset(
                          "assets/images/ticket.png",color: Colors.white,
                          scale: 14,
                        ),
                        Text(
                          "Ticket",
