...
class ClubPage3 extends StatefulWidget {
  ClubPage3(
      ...
      required this.femaleid,required this.totalpricewithoutcode,
                                    ...
                                    child: InkWell(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            (widget.totalprice +
                                                    widget.totalpricewithoutcode * 4 / 100 +
                                                    gst18.floor())
                                                .toString(),
                                            style: GoogleFonts.sairaCondensed(
                                                color: const Color(0XFF222222),
                                                ...
                                                Text(
                                                    ...
                                                    style:
                                                        GoogleFonts.sairaCondensed(
                                                            ...
                                                            color: Colors.black)),
                                                Text(
                                                    (widget.promocode.isNotEmpty)?widget.promopersent.toString():"",
                                                    style:
                                                        GoogleFonts.sairaCondensed(
                                                            fontWeight:
                                                                FontWeight.w600,
                                  ...
                                  children: [
                                    Text("Convience Fees",
                                        style: GoogleFonts.sairaCondensed(
                                            ...
                                            color: Colors.black)),
                                    Text(
                                        "Rs.${widget.totalpricewithoutcode * 4 / 100 + gst18.floor()}"
                                            ,
                                        style: GoogleFonts.sairaCondensed(
                                            fontWeight: FontWeight.w800,
                                            fontSize: width / 14.67857142857143,
                                        ...
                                        children: [
                                          Text(
                                              ...
                                              style: GoogleFonts.sairaCondensed(
                                                  ...
                                                  color: Colors.black)),
                                          Text(
                                              "Rs.${tables[index].value * tables[index].key.current * 4 / 100}",
                                              style: GoogleFonts.sairaCondensed(
                                                  fontWeight: FontWeight.w600,
                                                  fontSize:
                                                      width / 22.83333333333333,
                                        ...
                                        children: [
                                          Text(
                                              ...
                                              style: GoogleFonts.sairaCondensed(
                                                  ...
                                                  color: Colors.black)),
                                          Text(
                                              "Rs.${orders[index].value * orders[index].key.current * 4 / 100}",
                                              style: GoogleFonts.sairaCondensed(
                                                  fontWeight: FontWeight.w600,
                                                  fontSize:
                                                      width / 22.83333333333333,
