...
class MyRestoBar extends StatefulWidget {
  const MyRestoBar({super.key});

  @override
  State<MyRestoBar> createState() => _MyRestoState();
}

class _MyRestoState extends State<MyRestoBar> {
  late ClubModel? club=Constants.myrestobar;
  bool isloded = false;
  loadclub() async {
    club = await BTSRestoServices.btsgetSingleresto(context: context);
    setState(() {
      print("object");
      isloded = true;
    });
