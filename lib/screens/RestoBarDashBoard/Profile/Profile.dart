...
import 'package:venq_assessment/screens/RestoBarDashBoard/Profile/Myresto.dart';
import 'package:venq_assessment/screens/RestoBarDashBoard/Profile/Ticketsbts.dart';
import 'package:venq_assessment/utils/Constants.dart';
import 'package:venq_assessment/widgets/ClubDashBoard/HeaderContent.dart';

class BTSRestoProfile extends StatefulWidget {
  const BTSRestoProfile({super.key});

  @override
  State<BTSRestoProfile> createState() => _BTSRestoProfileState();
}

@override
class _BTSRestoProfileState extends State<BTSRestoProfile> {
  late UserData user;
  bool loded = false;
  getuser() async {
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const RestoBTSTicket()));
                        },
                        child: Row(
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const MyRestoBar()));
                        },
                        child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
